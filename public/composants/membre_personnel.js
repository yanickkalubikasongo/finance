        ...
        if(extension != '.jpg' && extension != '.png') {
            ...
            .done((response)=>{
                if(response.reponse=='r'){
                    ...
                    swal({
                        title: "Succès",
                        text: "Membre Finuseco enregistré avec succès !",
                        icon: "success",
                        button: false,
                    });
                }
                    ...
                    if(response.reponse =='deconnexion'){
                        window.location.replace("https://admin.finuseco.com/")
                    }else{
                ...
                res.map((item)=>{
                    if(item.etat_us == 1){
                        ...
                        this.setState({
                            ...
                            img             :"https://admin.finuseco.com/"+item.photo,
                            one_erreur      :"https://agence.finuseco.com/"+item.photo,
                ...
                <div className="col-12">
                    <div className="card form-card" style={stylefrom} >
                        <div className="card-body" >
                            ...
                            {(this.state.state_msg == 'attente') ? <i id="sp" className="fas fa-spinner fa-pulse" style={spinner}></i> : '' } 
                            <br/>
                            {(photo) ? <img style={styleimg} src={photo} onError={replaceImage} className="rounded-circle" /> : '' } <br/><br/>
                            <table className="table table-striped" id="example">
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    {(this.state.compte !='') ?  <tr><td className="col-1">Denomination</td><td>: {denomination}</td><td>Autorisation</td><td>: <a href={'https://admin.finuseco.com/'+autorisation} target="blank">Document administratif</a> </td></tr> :'' }
                                    {(this.state.compte !='') ?  <tr><td className="col-1">Email</td><td>: {email}</td><td>Adresse Physique</td><td>: {adresse_physique}</td></tr> :'' }
                                    ...
                                    {(this.state.compte !='') ?  <tr><td className="col-1"><img style={styleimg} src={'https://admin.finuseco.com/'+photo} className="rounded-circle" /></td><td></td>
                                            <td colspan="2">
...
class Repertoire_agence extends React.Component {
    ...
    async modifier(event) {
        ...
        if(res =='deconnexion' || solde.result =='deconnexion')  window.location.replace("https://admin.finuseco.com/")
...
class Config_transaction extends React.Component {
    ...
    async modifier(event) {
        ...
        if(res =='deconnexion') window.location.replace("https://admin.finuseco.com/")
        res.map(item => (
            this.setState({
                min      :item.minimum,
                max      :item.maximum,
    ...
    async rechercher(event) {
        ...
        if(rep.result =='deconnexion')  window.location.replace("https://admin.finuseco.com/")
...
class Depot_usd extends React.Component {
    ...
    async send(event) {
        ...
        if(send_compte.result =='deconnexion') window.location.replace("https://admin.finuseco.com/")
...
class Configuration_generaux extends React.Component {
    ...
    async send(event) {
        ...
        if(send.result =='deconnexion') window.location.replace("https://admin.finuseco.com/")
        if(send.result =='r'){
            this.setState({
...
class Wallet_don extends React.Component {
    ...
    async send_wallet_don(event) {
        ...
        if(response2.result =='deconnexion') window.location.replace("https://admin.finuseco.com/")
        ...
        .then(async (element) => {
            ...
            if(ckeck_mdp.result == true){
                ...
                let data = { id :'' },
                    ...
                    if(wallet_don.result =='deconnexion')  window.location.replace("https://admin.finuseco.com/")
...
rep_compte.addEventListener('click',async (e)=>{
    ...
    if(res_type_piece =='deconnexion') window.location.replace("https://admin.finuseco.com/")
...
membre.addEventListener('click',async(e)=>{
    ...
    if(res_membre.result =='deconnexion')  window.location.replace("https://admin.finuseco.com/")
...
rep_partenaire.addEventListener('click',async (e)=>{
    ...
    let dataPertenaire = {
        ...
        res = response_rep_part.reponse
    if(response_rep_part.result =='deconnexion') window.location.replace("https://admin.finuseco.com/")
    let root = ReactDOM.createRoot(document.querySelector('.corps'));
